...
> 🎙️ 纯语音驱动的 AI 绘画助手 · 为 七牛云 AI 应用创新挑战赛「第二赛道 · AI 创意应用」而做
>
> 仓库地址：[github.com/Nathanstefanqian/voicePainter](https://github.com/Nathanstefanqian/voicePainter)
...
第二题「AI 创意应用」要求用 AI 模型做出有创意的应用。VoicePaint 的对应关系如下：

- **使用 AI 模型**：DeepSeek-V3（意图理解）+ Doubao-Seedream-5.0（图像生成）+ 火山 ASR / 腾讯云 ASR（语音识别）。
- **解决真实问题**：把 AI 绘图的入口从"键盘+鼠标"前置到"语音"，覆盖无法/不便打字的场景（驾驶、烹饪、视障、灵感爆发时）。
...
> 如果只想读 5 个文件就能理解整个项目，建议看下面这 5 个：
